(function(){
    ...
    Bitmap.prototype.cloneProps = function(){
        return {image:this.image, rect:[this.rectX,this.rectY,this.rectWidth,this.rectHeight],regX:this.regX,regY:this.regY};
    }
    ...
    Bitmap.prototype.setImage = function(img){
        this.image = img;
        this.setDrawable(this.image);
    }
    /**
